...
type loaderData = { other: Array<others> };
  ...
  return (
    <>
      ...
      <div className="home">
          ...
          <Table striped bordered hover variant="dark">
            ...
            <tbody className="text-center">
              {data.other
                ...
                .map((others) => (
                  <tr>
                    <td key={others.id}>{others.id}</td>
                    <td key={others.id}>{others.name}</td>
                    <td>
                      <div className="flex flex-col items-center ">
                        <a
                          className="remove"
                          href={`/admin/other/delete/${others.id}`}
                        >
                          Remove
                        </a>
                      </div>
                    ...
                    <td>
                      <div className="flex flex-col items-center">
                        <a
                          className="update"
                          href={`/admin/other/update/${others.id}`}
                        >
                          Update
                        </a>
                      </div>
        ...
        <a className="create" href="/admin/other/create/create">
          Create
        </a>
      </div>
    </>
